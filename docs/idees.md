...
**Un mélange d'histoire et de fiction**, décidé le 26 août 2026 : un déroulé
chronologique de 1844 à 1999 qui suit **une famille de télégraphistes, de père
en fils**. On commence à l'invention, on traverse les guerres, on finit avec la
fin du morse. Les situations et les textes sont historiques ; seule la famille
est inventée.

C'est la bonne formule : l'Histoire fournit le récit, les dates et les
véritables messages ; la famille fournit le fil et l'attachement, que dix
épisodes indépendants n'auraient jamais donnés.

**Une règle à tenir sans exception** : à la fin de chaque épisode, dire ce qui
est vrai et ce qui est inventé. Le site est un site d'apprentissage ; laisser
...
- **Volume des épreuves** : cent caractères au maximum, pour une ou deux
  ...
  effort, ce qui autorise une épreuve longue de temps en temps.
- **« Entre les ondes »** : au moins un par génération à partir de la deuxième.
- **Sauvegarde** : bouton dans le bandeau, visible seulement dans le mode
  histoire.
